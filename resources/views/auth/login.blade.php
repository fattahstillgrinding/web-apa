...
<head>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes logoPulse {
            0%, 100% { box-shadow: 0 0 30px rgba(99,102,241,0.4), 0 8px 20px rgba(0,0,0,0.3); }
            50%       { box-shadow: 0 0 50px rgba(99,102,241,0.6), 0 8px 20px rgba(0,0,0,0.3); }
        }
    ...
    <div class="login-card">
        ...
        <div class="hint-box">
            <div class="hint-box-title">
                <i class="bi bi-info-circle"></i> Akun Default
            </div>
            <p>
                Email: <code>admin@sekolah.com</code><br>
