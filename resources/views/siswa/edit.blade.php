...
<div class="page-header">
    <div class="page-header-row">
        <div>
            <h1><i class="bi bi-pencil-square" style="font-size:1.5rem;margin-right:8px;"></i>Edit Data Siswa</h1>
            <p>Perbarui informasi siswa <strong style="color:var(--primary-light)">{{ $siswa->nama }}</strong>.</p>
        </div>
...
<div class="card">
    <form action="{{ route('siswa.update', $siswa) }}" method="POST" id="editForm" novalidate>
        @csrf
        @method('PUT')
        ...
        <div style="display:flex;gap:10px;justify-content:flex-end;flex-wrap:wrap;">
            ...
            <button type="submit" class="btn btn-primary" id="submitBtn">
                <i class="bi bi-floppy2-fill"></i> Perbarui Data
            </button>
        </div>
    </form>
</div>
